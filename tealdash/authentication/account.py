...
from tealdash.tasks import send_mail
from tealdash.utils import base_url
...
def send_invite_email(inviter, invited, invite_url, org):
    ...
    subject = "{} invited you to join Tealdash".format(inviter.name)
...
def send_user_disabled_email(user):
    ...
    subject = "Your Tealdash account is disabled"
