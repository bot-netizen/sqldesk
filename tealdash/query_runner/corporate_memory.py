...
class CorporateMemoryQueryRunner(BaseQueryRunner):
    """Use eccenca Corporate Memory as a data source"""
    ...
    def __init__(self, configuration):
        ...
        """
        FEATURE?: activate SPARQL support in the query editor
    ...
    def _transform_sparql_results(results):
        ...
        # transform all bindings to rows
        rows = []
    ...
    def run_query(self, query, user):
        ...
        if query_type not in ["SELECT", None]:
            raise ValueError("Queries of type {} can not be processed by tealdash.".format(query_type))
