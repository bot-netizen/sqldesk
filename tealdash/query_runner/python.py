...
from tealdash.permissions import has_access, not_view_only, view_only
...
if pandas_installed:
    ...
    from tealdash.utils.pandas import pandas_to_result
...
class Python(BaseQueryRunner):
    ...
    def add_result_column(result, column_name, friendly_name, column_type):
        """Helper function to add columns inside a Python script running in Tealdash in an easier way
