...
from tealdash.models.users import ApiUser, User
...
from tealdash.settings import parse_boolean
...
class Trino(BaseSQLQueryRunner):
    ...
    def configuration_schema(cls):
        return {
            ...
            "properties": {
                ...
                "source": {"type": "string", "default": "tealdash"},
    ...
    def run_query(self, query, user):
        ...
        connection = trino.dbapi.connect(
            ...
            source=self.configuration.get("source", "tealdash"),
