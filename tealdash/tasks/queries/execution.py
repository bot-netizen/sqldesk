...
from tealdash.query_runner import InterruptException
from tealdash.tasks.alerts import check_alerts_for_query
from tealdash.tasks.failure_report import track_failure
from tealdash.tasks.worker import Job, Queue
from tealdash.utils import gen_query_hash, utcnow
from tealdash.worker import get_job_logger

logger = get_job_logger(__name__)
TIMEOUT_MESSAGE = "Query exceeded Tealdash query execution time limit."
