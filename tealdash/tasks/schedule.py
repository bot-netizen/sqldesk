...
from tealdash import rq_redis_connection, settings
from tealdash.tasks.failure_report import send_aggregated_errors
from tealdash.tasks.general import sync_user_details, version_check
from tealdash.tasks.queries import (
...
class StatsdRecordingScheduler(Scheduler):
    """
    RQ Scheduler Mixin that uses Tealdash's custom RQ Queue class to increment/modify metrics via Statsd
    """
