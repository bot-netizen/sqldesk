...
from tealdash.destinations import BaseDestination, register
    ...
    ALERTS_DEFAULT_MESSAGE_TEMPLATE = json_dumps(
        {
            ...
            "themeColor": "0076D7",
            "summary": "A Tealdash Alert was Triggered",
            "sections": [
                {
                    "activityTitle": "A Tealdash Alert was Triggered",
                    "facts": [
