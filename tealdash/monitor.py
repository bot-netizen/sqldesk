...
from tealdash import __version__, redis_connection, rq_redis_connection, settings
from tealdash.models import Dashboard, Query, QueryResult, Widget, db
...
def get_db_sizes():
    ...
    queries = [
        ...
        ["Tealdash DB Size", "select pg_database_size(current_database()) as size"],
    ]
...
def get_status():
    ...
    status["manager"] = redis_connection.hgetall("tealdash:status")
