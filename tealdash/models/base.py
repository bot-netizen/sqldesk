...
class TealdashSQLAlchemy(SQLAlchemy):
    def apply_driver_hacks(self, app, info, options):
        ...
        return super(TealdashSQLAlchemy, self).apply_driver_hacks(app, info, options)

    def apply_pool_defaults(self, app, options):
        super(TealdashSQLAlchemy, self).apply_pool_defaults(app, options)
        if settings.SQLALCHEMY_ENABLE_POOL_PRE_PING:
