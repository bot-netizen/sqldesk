...
from tealdash.handlers.alerts import (
...
from tealdash.handlers.dashboards import (
...
from tealdash.handlers.data_sources import (
...
from tealdash.handlers.databricks import (
    DatabricksDatabaseListResource,
    DatabricksSchemaResource,
    DatabricksTableColumnListResource,
)
from tealdash.handlers.destinations import (
    DestinationListResource,
    DestinationResource,
    DestinationTypeListResource,
)
from tealdash.handlers.events import EventsResource
from tealdash.handlers.favorites import (
    DashboardFavoriteResource,
    QueryFavoriteResource,
)
from tealdash.handlers.groups import (
...
from tealdash.handlers.permissions import (
    CheckPermissionResource,
    ObjectPermissionsListResource,
)
from tealdash.handlers.queries import (
    MyQueriesResource,
...
from tealdash.handlers.query_results import (
    JobResource,
...
from tealdash.handlers.query_snippets import (
    QuerySnippetListResource,
    QuerySnippetResource,
)
from tealdash.handlers.settings import OrganizationSettings
from tealdash.handlers.uploads import (
    DataSourceUploadListResource,
    DataSourceUploadResource,
)
from tealdash.handlers.users import (
    UserDisableResource,
    UserInviteResource,
    UserListResource,
...
from tealdash.handlers.visualizations import (
    VisualizationListResource,
    VisualizationResource,
)
from tealdash.handlers.widgets import WidgetListResource, WidgetResource
...
api.add_org_resource(
    DataSourceUploadListResource,
    "/api/data_sources/<data_source_id>/uploads",
    endpoint="data_source_uploads",
)
api.add_org_resource(
    DataSourceUploadResource,
