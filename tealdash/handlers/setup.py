...
from tealdash.models import Group, Organization, User, db
from tealdash.tasks.general import subscribe
...
def setup():
    ...
    if request.method == "POST" and form.validate():
        ...
        return redirect(url_for("tealdash.index", org_slug=None))
