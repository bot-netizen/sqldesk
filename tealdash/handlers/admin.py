...
from tealdash import models, redis_connection
from tealdash.authentication import current_org
from tealdash.handlers import routes
from tealdash.handlers.base import json_response, record_event
from tealdash.monitor import rq_status
from tealdash.permissions import require_super_admin
from tealdash.serializers import QuerySerializer
...
def outdated_queries():
    manager_status = redis_connection.hgetall("tealdash:status")
