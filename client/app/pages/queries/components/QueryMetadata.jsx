...
export default function QueryMetadata({ query, dataSource, layout, onEditSchedule, showSchedule }) {
  return (
...
QueryMetadata.propTypes = {
  ...
  // The editor surfaces the schedule as a header control instead, so it opts
  // out here rather than showing it twice.
