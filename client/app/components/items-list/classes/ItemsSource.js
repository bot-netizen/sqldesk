  ...
  _changed(changes) {
    ...
    return this._beforeUpdate().then(() => {
      ...
      return this._fetcher
        ...
        .then(({ results, count, allResults, meta }) => {
          if (this._currentFetchToken === fetchToken) {
            ...
            // `meta` is namespaced rather than spread, so a response field
            // can never quietly overwrite a route param of the same name.
            this._params = { ...this._params, ...customParams, meta: meta || {} };
