...
from sqldesk.utils import base_url, json_dumps, json_loads, render_template
...
def send_failure_report(user_id):
    ...
    if errors:
        ...
        subject = f"SQLDesk failed to execute {len(unique_errors.keys())} of your scheduled queries"
        html, text = [
