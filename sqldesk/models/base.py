...
class SQLDeskSQLAlchemy(SQLAlchemy):
    def apply_driver_hacks(self, app, info, options):
        ...
        return super(SQLDeskSQLAlchemy, self).apply_driver_hacks(app, info, options)

    def apply_pool_defaults(self, app, options):
        super(SQLDeskSQLAlchemy, self).apply_pool_defaults(app, options)
        if settings.SQLALCHEMY_ENABLE_POOL_PRE_PING:
