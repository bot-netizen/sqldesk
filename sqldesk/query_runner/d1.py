...
from sqldesk.utils.requests_session import requests_session as session

# Map Python types to SQLDesk types
TYPES_MAP = {
    "str": TYPE_STRING,
    "int": TYPE_INTEGER,
    "float": TYPE_FLOAT,
    ...
    def run_query(self, query, user):
        try:
            ...
            for k, v in first_row.items():
                # Get the Python type name and map it to SQLDesk type
