...
from sqldesk.tasks import record_event as record_event_task
from sqldesk.utils import json_dumps
from sqldesk.utils.query_order import sort_query

routes = Blueprint("sqldesk", __name__, template_folder=settings.fix_assets_path("templates"))
