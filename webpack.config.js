...
const config = {
  ...
  devServer: {
    client: {
      overlay: {
        // The "ResizeObserver loop completed with undelivered notifications" message
        // is a benign browser quirk (antd's Table/List/grid-layout trigger it constantly)
        // and not an actual app error, so don't let it trip the red-screen overlay.
